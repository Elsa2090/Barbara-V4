...
<h2 align="cener">𝙃𝙊𝙒 𝙏𝙊 𝘿𝙀𝙋𝙇𝙊𝙔 𝙊𝙉 𝙏𝙀𝙍𝙈𝙐𝙓</h2>

## Install Several Packages And Run Bots

```csharp
> git clone https://github.com/Elsa2090/Barbara-V4 
> apt-get update -y
> apt-get upgrade -y
...
```
# Instalasi
* [Pair code](https://barbara-session-id.vercel.app)
* [Heroku](  https://heroku.com/deploy?template=https://github.com/Elsa2090/Barbara-V4)
## Heroku Buildpack
```bash
heroku/nodejs
...
<div><button id="boton" type="button">Base  - BY JFLEX OG</button></div>
<a href="https://github.com/JFLEX019"><img src="https://github.com/JFLEX019.png" width="150" height="150" alt="JFLEX OG"/></a>
